    ...
    <div class="containerCustomer go-register">
        ...
        <div class="form__container form__container-register">
            <form method="POST" action="{{ route('rider.register') }}" class="form">
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        <input type="text" class="form__field @error('license_number') is-invalid @enderror" placeholder="License Number" name="license_number" value="{{ old('license_number') }}" required autocomplete="license_number">
