...
Route::middleware(['admin'])->group(function () {
    ...
    Route::get('statusCancel{id}', 'BookingController@cancel_ride')->name('statusCancel');
    Route::get('status_cancel_rider{id}', 'BookingController@cancel_ride_rider')->name('status_cancel_rider');
